  ...
  return (
    <div>
      ...
      <div className='center home1 bg pt-4'>
        ...
        <p className='map-text m-0 pb-4'>Explore the city with Google Maps!</p>
      </div>
      </div>
